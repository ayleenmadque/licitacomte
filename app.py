...
for s in secciones:
    ...
    slug = s.replace(" ", "+")
    tabs_html += f'<a href="?tab={slug}" style="padding:14px 0; text-align:center; font-size:15px; font-weight:500; color:{color}; border-bottom:{borde}; cursor:pointer; text-decoration:none; display:block;">{s}</a>'
tabs_html += '</div>'
